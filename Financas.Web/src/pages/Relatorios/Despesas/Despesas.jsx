...
function Despesas() {
  ...
  if (modoDocumento) {
    ...
    const resumoData = [
      ...
      { label: "Registros", valor: despesas.length },
      {
        label: "Período",
    ...
    const secoes = [
      {
        titulo: "Gráfico - Despesas por Dia",
        grafico: <BarChart labels={labels} values={values} color="#ef4444" />,
      },
      {
    ...
    return (
      ...
      >
        ...
        <RelatorioDocumento
          ...
          descricao="Detalhamento de todas as despesas cadastradas no sistema"
          resumo={resumoData}
          secoes={secoes}
