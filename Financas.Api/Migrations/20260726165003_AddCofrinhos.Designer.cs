...
namespace Financas.Api.Migrations
{
    ...
    [Migration("20260726165003_AddCofrinhos")]
    partial class AddCofrinhos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Financas.Api.Entities.Cofrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("cofrinhos", (string)null);
                });
            ...
            modelBuilder.Entity("Financas.Api.Entities.Transferencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Financas.Api.Entities.Lancamento", b =>
                {
                    ...
                    b.HasOne("Financas.Api.Entities.Cofrinho", "Cofrinho")
            ...
            modelBuilder.Entity("Financas.Api.Entities.Transferencia", b =>
                {
                    b.HasOne("Financas.Api.Entities.ContaBancaria", "ContaDestino")
                        .WithMany("TransferenciasDestino")
                        .HasForeignKey("ContaDestinoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Financas.Api.Entities.ContaBancaria", "ContaOrigem")
